        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                With over 5 years of dedicated experience in physiotherapy, I specialize in providing comprehensive
                rehabilitation services that help patients regain mobility, reduce pain, and improve their quality of
                life.
              </p>
            </div>
            ...
            {/* Qualifications */}
            <div className="space-y-4">
              <h3 className="text-xl font-semibold text-foreground">Qualifications & Expertise</h3>
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="flex items-start space-x-3">
                  <GraduationCap className="w-5 h-5 text-primary mt-1 flex-shrink-0" />
                  <div>
                    <div className="font-medium text-foreground">Bachelor of Physiotherapy (BPT)</div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <div className="font-medium text-foreground">Neuro & Ortho Specialist</div>
                    <div className="text-sm text-muted-foreground">Advanced Training</div>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <Users className="w-5 h-5 text-primary mt-1 flex-shrink-0" />
                  <div>
                    <div className="font-medium text-foreground">500+ Patients Treated</div>
          ...
          <div className="relative">
            <div className="aspect-[4/5] bg-gradient-to-br from-primary/10 to-secondary/10 rounded-2xl overflow-hidden">
              <img
                src="/professional-physiotherapist-portrait-in-clinical-.png"
