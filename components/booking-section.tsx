          ...
          <Card className="text-center p-8">
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                <h3 className="text-2xl font-bold text-foreground">Appointment Request Submitted!</h3>
                <p className="text-muted-foreground">
                  Thank you for choosing our physiotherapy services. We'll contact you within 24 hours to confirm your
                  appointment details.
                </p>
              </div>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Fill out the form below to book your appointment. We'll contact you to confirm the details and answer any
            questions.
          </p>
        </div>
        ...
        <div className="mt-12 text-center">
          <p className="text-muted-foreground mb-4">Need immediate assistance? Contact us directly:</p>
