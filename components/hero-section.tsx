...
export default function HeroSection() {
  ...
  return (
    <section
      id="home"
      className="relative py-20 px-4 bg-gradient-to-br from-background to-muted/30"
    >
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground max-w-lg leading-relaxed">
                Professional rehabilitation services with 5+ years of experience
                in Neuro & Ortho therapy, Post-operative care, and advanced Pain
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-foreground">
                  BPT Qualified with 5+ Years Experience
                </span>
              </div>
              <div className="flex items-center space-x-3">
                <CheckCircle className="w-5 h-5 text-primary flex-shrink-0" />
                <span className="text-foreground">
                  Specialized in Neuro & Ortho Therapy
                </span>
              </div>
              <div className="flex items-center space-x-3">
                <CheckCircle className="w-5 h-5 text-primary flex-shrink-0" />
                <span className="text-foreground">
                  Advanced Electrotherapy & Ultrasonic Treatment
                </span>
              </div>
            </div>
